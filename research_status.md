...
| 载荷可行性图与回环 vs 重传交叉点 | **图 6 已形成（第 12 周）**：`research_reports/figures/fig6_feasibility.png`（有用区 τ/T∈[0.5,2]；电光 10.64 dB vs SOA 0.14 dB）；**图 5 已有初版**（第 11 周，回环 vs 重传按实测负载轴）；正负结论都可写 |

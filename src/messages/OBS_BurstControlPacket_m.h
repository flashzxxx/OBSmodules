...
{
  protected:
    simtime_t burstArrivalDelta_var;
    int burstColour_var;
    int label_var;
  ...
  public:
    ...
    virtual simtime_t getBurstArrivalDelta() const;
    virtual void setBurstArrivalDelta(simtime_t burstArrivalDelta);
...
#endif // ifndef _OBS_BURSTCONTROLPACKET_M_H_
